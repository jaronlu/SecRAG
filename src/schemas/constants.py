...
ROLE_ALLOWED_SOURCES: dict[str, list[str]] = {
    ROLE_ADVISOR: [SOURCE_PRODUCT, SOURCE_REGULATION, SOURCE_REPORT],
    ROLE_INSTITUTIONAL_SALES: [SOURCE_PRODUCT, SOURCE_REGULATION, SOURCE_REPORT],
    ROLE_COMPLIANCE: [SOURCE_PRODUCT, SOURCE_REGULATION, SOURCE_REPORT, SOURCE_FAQ],

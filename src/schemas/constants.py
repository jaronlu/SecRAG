...
STATE_THREAD_ID: Final = "thread_id"
STATE_TURN_ID: Final = "turn_id"
STATE_CHAT_HISTORY: Final = "chat_history"
STATE_CONVERSATION_SUMMARY: Final = "conversation_summary"
STATE_RESOLVED_QUERY: Final = "resolved_query"
STATE_TURN_INDEX: Final = "turn_index"
...
STATE_TOOL_ITERATIONS: Final = "tool_iterations"
...
AUDIT_REASONING_EXECUTION_PATH: Final = "execution_path"
AUDIT_REASONING_NODE_TIMINGS: Final = "node_timings"
AUDIT_TOTAL_DURATION_MS: Final = "total_duration_ms"
...
ROLE_ALLOWED_SOURCES: dict[str, list[str]] = {
    ROLE_ADVISOR: [SOURCE_PRODUCT, SOURCE_REGULATION, SOURCE_REPORT, SOURCE_SQL],
    ROLE_INSTITUTIONAL_SALES: [SOURCE_PRODUCT, SOURCE_REGULATION, SOURCE_REPORT, SOURCE_SQL],
    ROLE_COMPLIANCE: [SOURCE_PRODUCT, SOURCE_REGULATION, SOURCE_REPORT, SOURCE_FAQ, SOURCE_SQL],
    ROLE_OPERATIONS: [SOURCE_PRODUCT, SOURCE_REGULATION, SOURCE_REPORT, SOURCE_FAQ],
    ROLE_TECHNICAL: [SOURCE_PRODUCT, SOURCE_REGULATION, SOURCE_REPORT, SOURCE_FAQ],
}
